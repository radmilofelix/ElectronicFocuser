...
{
  Serial2.println("");
  Serial2.print("MaxStepsAbsolute: "); Serial2.println(fstepper.maxStepsAbsolute);
  Serial2.println("");
  notInit = false;
...
// Stage 1. - Finding zero position
  {
    ...
    Serial2.print("MaxSteps: "); Serial2.print(fstepper.maxSteps); Serial2.print("; StepPosition: "); Serial2.print(fstepper.stepPosition); Serial2.print("; StepTarget: "); Serial2.print(fstepper.stepTarget);
    Serial2.print("; LostSteps: "); Serial2.println(lostSteps);  
    SignalBeeps(2,1500);
    delay(1000);
  }
else
...
// Stage 4. - Seek zero position at low speed, correct max. steps
  ...
  Serial2.print("MaxSteps: "); Serial2.print(fstepper.maxSteps); Serial2.print("; StepPosition: "); Serial2.print(fstepper.stepPosition); Serial2.print("; StepTarget: "); Serial2.print(fstepper.stepTarget);
  Serial2.print("; LostSteps: "); Serial2.println(lostSteps-(long)fstepper.maxStepsAbsolute/8);
  SignalBeeps(2,1500);
  delay(1000);
...
{
	if(! modbus_f.dataBuffer[REGCOMMANDFROMPI])
		return;
  #ifdef DEBUG
  Serial2.print("Remote Command: "); Serial2.print( modbus_f.dataBuffer[REGCOMMANDFROMPI]); Serial2.print(" - ");
  #endif
  ...
  switch(modbus_f.dataBuffer[REGCOMMANDFROMPI])
  {
    ...
    case CMDGOTOPOSITION:
      ...
      #ifdef DEBUG
      Serial2.print("Goto position: "); Serial2.println(fstepper.stepTarget);
      #endif // DEBUG
      remoteControlEnabled = false;
    ...
    case CMDGOTORELATIVE:
      ...
      #ifdef DEBUG
      Serial2.print("Goto Relative position: "); Serial2.println(relativeSteps);
      #endif // DEBUG
      remoteControlEnabled = false;
      fstepper.EnableMotor(true);
      fstepper.CorrelateSpeed(relativeSteps);
